                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="<?php echo base_url()?>/login.php">Return to login</a>
                                                <a class="btn btn-primary" href="<?php echo base_url()?>/login.php">Reset Password</a>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="<?php echo base_url()?>/register.php">Need an account? Sign up!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
