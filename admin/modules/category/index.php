...
<?php  
    ...
    if( getInput('search') !=''){
        $category=$db->fetchJone("loaisanpham","SELECT * FROM loaisanpham WHERE TenLoaiSanPham like'%".getInput('search') ."%'",0,false);
                                ...
                                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    <div class="row">
                                        ...
                                        <form class="col-sm-12 col-md-6" method="get">
                                            <div id="dataTable_filter" class="dataTables_filter" style="text-align:left"><label>Search:<input style="width: 730px;"type="search" class="form-control" placeholder="tìm kiếm tên loại sản phẩm" name="search" aria-controls="dataTable"></label></div>
                                        </form>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; text-align: center;">
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 405px;">Tên Loại SP</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 700px;">Hình Ảnh SP</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 500px;">Lựa Chọn</th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <?php $stt=1; foreach ($category as $item):?>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class=""> <?php echo $item['TenLoaiSanPham'] ?> </td>
                                                            <td class=""> <?php echo $item['HinhAnhLoaiSanPham'] ?> </td>
                                                            <td class="">   
