...
<?php  
    ...
    if( getInput('search') !=''){
        $category=$db->fetchJone("chitietdonhang","SELECT * FROM chitietdonhang WHERE TenSanPham like'%".getInput('search') ."%'",0,false);
        
    }
    else{
        $category = $db->fetchAll("chitietdonhang");    
    }
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <div class="row" >
                            <h1 class="mt-4">DS chi tiết đơn hàng </h1>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; text-align: center;">
                                                <thead>
                                                    <tr role="row">
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 108px;">STT</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 405px;">Mã Đơn Hàng</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 700px;">Mã Sản Phẩm</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 700px;">Tên Sản Phẩm</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 700px;">Giá Sản Phẩm</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 500px;">Sô Lượng Sản Phẩm</th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <?php $stt=1; foreach ($category as $item):?>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class=""> <?php echo $item['MaDonHang'] ?> </td>
                                                            <td class=""> <?php echo $item['MaSanPham'] ?> </td>
                                                            <td class=""> <?php echo $item['TenSanPham'] ?> </td>
                                                            <td class=""> <?php echo $item['GiaSanPham'] ?> </td>
                                                            <td class=""> <?php echo $item['SoLuongSanPham'] ?> </td>
                                                            <!-- <td class="">   
