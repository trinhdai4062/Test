...
<?php  
    ...
    if( getInput('search') !=''){
        $category=$db->fetchJone("donhang","SELECT * FROM donhang WHERE TenKhachHang like'%".getInput('search') ."%'",0,false);
        
    }
    else{
        $category = $db->fetchAll("donhang");    
    }
                                ...
                                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    <div class="row">
                                        ...
                                        <form class="col-sm-12 col-md-6" method="get">
                                            <div id="dataTable_filter" class="dataTables_filter" style="text-align:left"><label>Search:<input style="width: 730px;"type="search" class="form-control" placeholder="tìm kiếm tên khách hàng" name="search" aria-controls="dataTable"></label></div>
                                        </form>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; text-align: center;">
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 405px;">Tên Khách Hàng</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 700px;">Số Điện Thoại</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 500px;">Email</th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <?php $stt=1; foreach ($category as $item):?>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class=""> <?php echo $item['TenKhachHang'] ?> </td>
                                                            <td class=""> <?php echo $item['SDT'] ?> </td>
