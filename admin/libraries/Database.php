...
<?php 
    ...
    */
    class Database
    {
        ...
        {
            $this->link = mysqli_connect("localhost","root","","daioktkp_Shose") or die ("error");
           // $this->link = mysqli_connect("localhost","id15957850_daiokok","Dai123456789ZZ@@","id15957850_banshose") or die ("error");
